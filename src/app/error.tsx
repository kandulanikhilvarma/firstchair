...
export default function Error({ reset }: { error: Error; reset: () => void }) {
  return (
    <main className="mx-auto flex max-w-md flex-1 flex-col items-center justify-center gap-3 px-6 py-24 text-center">
      <h1 className="font-display text-3xl text-ink-900">Something went wrong</h1>
      ...
      <button
        type="button"
        onClick={reset}
        className="mt-2 cursor-pointer bg-ox-700 px-5 py-2.5 font-semibold text-canary-100 hover:bg-ox-900"
      >
        Try again
      </button>
    </main>
